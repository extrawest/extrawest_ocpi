...
def test_cpo_get_tariffs_v_2_1_1():
    app = get_application(
    ...
    response = client.get("/ocpi/cpo/2.1.1/tariffs")
...
def test_emsp_get_tariff_v_2_1_1():
    ...
    client = TestClient(app)
    response = client.get(
        f"/ocpi/emsp/2.1.1/tariffs/{settings.COUNTRY_CODE}/{settings.PARTY_ID}"
        f'/{TARIFFS[0]["id"]}'
    )
...
def test_emsp_add_tariff_v_2_1_1():
    app = get_application(
        version_numbers=[VersionNumber.v_2_1_1],
        roles=[enums.RoleEnum.emsp],
        crud=Crud,
...
def test_emsp_patch_tariff_v_2_1_1():
    app = get_application(
        version_numbers=[VersionNumber.v_2_1_1],
        roles=[enums.RoleEnum.emsp],
        crud=Crud,
...
def test_emsp_delete_tariff_v_2_1_1():
    app = get_application(
        version_numbers=[VersionNumber.v_2_1_1],
        roles=[enums.RoleEnum.emsp],
        crud=Crud,
